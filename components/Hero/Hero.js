...
import { MENULINKS, METADATA, TYPED_STRINGS } from "../../constants";
    ...
    >
      ...
      <div className="flex flex-col pt-40 md:pt-0 select-none">
        ...
        <h1 className={`${styles.heroName} text-white text-6xl font-semibold`}>
          <span className={`relative ${styles.emphasize} seq`}>{METADATA.author.split(" ")[0]}</span>
          <span className="seq">{" "}{METADATA.author.split(" ")[1]}</span>
        </h1>
        <p>
          <span
            ref={typedEl}
